...
const AP_Param::Info Rover::var_info[] = {
    ...
    // @Values: 0:Manual,1:Acro,3:Steering,4:Hold,5:Loiter,6:Follow,7:Simple,10:Auto,11:RTL,12:SmartRTL,15:Guided,17:ModeTBM
    // @User: Advanced
...
#if AP_ROBOTARMWP == ENABLED
    // @Group: ROBOTARMWP_
    // @Path: AE_RobotArmWP.cpp,../libraries/AE_RobotArmWP/AE_RobotArmWP.cpp
